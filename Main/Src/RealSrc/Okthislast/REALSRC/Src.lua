--[[
    Sapphire UI Library
    A feature-rich GUI library for Roblox exploit scripts.
    Includes windows, tabs, sections, and a wide variety of elements.
    Supports themeing, notifications, configuration saving, and more.
    ...
    lib:Notify({Title = "Hello", Content = "World", Duration = 5})
    lib:Init()
--]]
...
padding.PaddingRight = UDim.new(0, 15)
    ...
    function Window:CreateTab(name, iconID)
        ...
        -- Element factories
        local function elementBase(name, configText, hasOptions)
        ...
        function Tab:CreateColorPicker(config)
            ...
            local colorBox = Instance.new("Frame", frame) -- color preview
    ...
    function Window:SetTheme(theme)
        if SapphireLib.Themes[theme] then
            ...
            -- Update all themed objects by iterating children
            -- For simplicity, we'll just apply to main containers
